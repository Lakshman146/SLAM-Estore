...
public class customerDAOImp implements customerDAO {
	...
	public String updateShpimentDetails(custCredModel ccm) {
		String update_shipment_details="update slam_customers set cust_name=? , cust_saddress=? , cust_spincode=?";
		int ur=jdbcTemplate.update(update_shipment_details,ccm.getCustName(),ccm.getCustSAddress(),ccm.getCustSpincode());
		if(ur>0) {
			return "Updated";
		}else {
			return "Not updated";
